...
Внизу сайта добавлен блок `Контакты` с интерактивной Google-картой и футер. Адрес сейчас указан как `Алматы, Абая 150`; если нужно поменять точку, замените адрес в `src` карты и контактные данные в [public/index.html](public/index.html).
